...
public class Controlador {
    ...
    public void iniciar(){
        ...
        listaF.getListado().add(new Factura(objCM.leerTexto("Digite numero de la Factura"),
                                        ...
                                        new Cliente(objCM.leerTexto("Digite codigo[cedula] del cliente:"),objCM.leerTexto("Digite nombre del cliente:"),objCM.leerTexto("Digite telefono del cliente:")),
        ...
        objCM.mostrar(listaF.getListado().get(aux).getCliente().toString() + "\n" + listaF.getListado().get(aux).getProductos().toString());
    ...
    public Producto nuevoProducto(){
        ...
        switch(opc){
            case 0:{
                objP = new Basico(objCM.leerTexto("Producto Basico\nDigite codigo:"),objCM.leerTexto("Digite nombre del producto:"),
